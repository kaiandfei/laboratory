      ...
      <div class="content">
        ...
        >
          ...
          <el-table-column prop="UseData.payload" label="" align="left" show-overflow-tooltip>
            <template #default="scope">
              <div class="disFlex">
                <div class="flex3">环境温度:&nbsp;&nbsp;&nbsp;{{ scope.row.UseData.payload?.Temp }}℃</div>
<!--                <div class="flex1"></div>-->
              </div>
              <div class="disFlex">
                <div class="flex3">
                  二氧化碳:&nbsp;&nbsp;&nbsp;{{ scope.row.UseData.payload?.CO2 }}ppm
                  {{
                    scope.row.UseData.payload
                        ? setData.carbon_dioxide < scope.row.UseData.payload.CO2
                        ? '(预警)'
                        : ''
                        : ''
                  }}
...
<!--                <div class="flex1"></div>-->
              ...
              <div class="disFlex">
                <div class="flex3">湿度:&nbsp;&nbsp;&nbsp;{{ scope.row.UseData.payload?.Humidity }}%rh</div>
<!--                <div class="flex1"></div>-->
              </div>
              <div class="disFlex">
                <div class="flex3">PM10:&nbsp;&nbsp;&nbsp;{{ scope.row.UseData.payload?.PM10 }}ug/m3</div>
<!--                <div class="flex1"></div>-->
              </div>
              <div class="disFlex">
                <div class="flex3">PM2.5:&nbsp;&nbsp;&nbsp;{{ scope.row.UseData.payload?.PM25 }}ug/m3</div>
<!--                <div class="flex1"></div>-->
              </div>
              <div class="disFlex">
                <div class="flex3">挥发性有机物:&nbsp;&nbsp;&nbsp;{{ scope.row.UseData.payload?.TVOC }}</div>
<!--                <div class="flex1"></div>-->
              </div>
            </template>
          </el-table-column>
            ...
            <div class="fl">
              <el-form label-width="150px" style="width: 400px; float: left">
                ...
                <el-form-item label="环境温度:">
                  <el-input v-model="setData.temperature" type="number"></el-input>
                  <span class="fl">°C</span>
                </el-form-item>
                <el-form-item label="二氧化碳:">
                  <el-input v-model="setData.carbon_dioxide" type="number"></el-input>
                  <span class="fl">ppm</span>
                </el-form-item>
                <el-form-item label="湿度:">
                  <el-input v-model="setData.humidity" type="number"></el-input>
                  <span class="fl">%rh</span>
                </el-form-item>
                <el-form-item label="PM10:">
                  <el-input v-model="setData.pm_ten" type="number"></el-input>
                  <span class="fl">ug/m3</span>
                </el-form-item>
                <el-form-item label="PM2.5:">
                  <el-input v-model="setData.pm_two" type="number"></el-input>
                  <span class="fl">ug/m3</span>
                </el-form-item>
                <el-form-item label="挥发性有机物:">
                  <el-input v-model="setData.compounds" type="number"></el-input>
                  <span class="fl">mg/m3</span>
                </el-form-item>
              </el-form>
            </div>
          </div>
...
import { ListItem } from '@service/intelligent-device/air-detection/types'
import {
  getAirSensor,
  findAirSensorSetting,
  saveAirSensorSetting
} from '@service/intelligent-device/air-detection/index'
...
const initData = (value: string) => {
  getAirSensor().then((res) => {
    console.log(res)
    data.value = res.data
    dataAll.value = res.data
  })
  findAirSensorSetting().then((res) => {
    console.log(res)
    if (res.code === 10) {
      if (res.data !== null) {
        setData.temperature = res.data.temperature
        setData.carbon_dioxide = res.data.carbon_dioxide
        setData.humidity = res.data.humidity
        setData.pm_ten = res.data.pm_ten
        setData.pm_two = res.data.pm_two
        setData.compounds = res.data.compounds
      }
    }
  })
}
  ...
  findAirSensorSetting().then((res) => {
    if (res.code === 10) {
      if (res.data !== null) {
        ...
        setData.temperature = 45
        setData.carbon_dioxide = 2000
        setData.humidity = 80
        setData.pm_ten = 0.6
        setData.pm_two = 36
        setData.compounds = 0
...
const saveDate = () => {
  console.log(setData)
  if (setData.temperature > 100 || setData.temperature < 0) {
    ElMessage({
      type: 'warning',
      message: '环境温度在0-100之间'
    })
    return
  }
  if (setData.carbon_dioxide > 1000000 || setData.carbon_dioxide < 0) {
    ElMessage({
      type: 'warning',
      message: '二氧化碳浓度在0-1000000'
    })
    return
  }
  if (setData.humidity > 200 || setData.humidity < 0) {
    ElMessage({
      type: 'warning',
      message: '湿度在0-200之间'
    })
  ...
  if (setData.pm_ten > 10 || setData.pm_ten < 0) {
    ElMessage({
      type: 'warning',
      message: 'PM10在0-10之间'
    })
  ...
  if (setData.pm_two > 1000 || setData.pm_two < 0) {
    ElMessage({
      type: 'warning',
      message: 'PM2.5在0-1000之间'
    })
    return
  }
  saveAirSensorSetting(setData).then((res) => {
    if (res.code === 10) {
      ElMessage({
        type: 'success',
        message: '设置成功'
