<template>
  <div>
    <el-dialog custom-class="return-dialog" v-model="returnState" width="50%" :title="title" :show-close="false"
      ...
      <div v-show="registrationStatus === 1">
          ...
          <div class="detailArea">
            ...
            <div class="nav" style="float: right">
              ...
              <div style="width: 50%; float: left; justify-content: left; display: flex">
                <el-date-picker v-model="returnRegistrationList.end_time" type="date" placeholder="选择日期"
                  format="YYYY/MM/DD" size="mini"></el-date-picker>
              </div>
            </div>
            <div class="nav" style="width: 50%">
            ...
            <div class="nav" style="float: right; height: 35%; display: block">
              ...
              <div v-for="item in returnRegistrationList.nuReturn" :key="item.id" class="value" style="margin-left: 20px">
                {{ item.asset_number }}
                {{ item.name }}
                {{ item.unReturnNum + '个' }}
              </div>
        ...
        <div class="tableArea">
          <el-table :data="returnRegistrationList.returnList" style="width: 100%" max-height="200px"
            :header-cell-style="{ background: '#DCECE3', color: '#000' }"
            :cell-style="{ background: '#ffffff', borderBottom: '1px solid #EFEFEF' }" default-expand-all row-key="id"
            ...
            <el-table-column label="仪器库" prop="laboratory_id">
              <template #default="scope">
                <div v-if="!scope.row.detail">
                  <select v-model="scope.row.laboratory_id"
                    @change="getData(scope.row.laboratory_id, scope.row.id, scope.$index)">
                    <option v-for="item in optionsLaboratory" :key="item.value" :label="item.name" :value="item.value">
                    </option>
                  </select>
                </div>
              ...
              <template #default="scope">
                <div v-if="!scope.row.detail">
                  <select v-model="scope.row.store_id">
                    <option v-for="item in optionStore(storeListBox[scope.$index])" :key="item.value" :label="item.name"
              ...
              <template #default="scope">
                <div v-if="!scope.row.detail">
                  <select v-model="scope.row.number_plies">
                    <option v-for="item in optionPlies(storeListBox[scope.$index], scope.row.store_id || 1)"
                      :key="item.value" :label="item.name" :value="item.value"></option>
                  </select>
                </div>
            ...
            <el-table-column label="操作">
              <template #default="scope">
                ...
                <div v-if="!scope.row.detail" style="color: green; cursor: pointer"
        ...
        <div class="topArea">
          <div class="detailArea">
            ...
            <div class="nav" style="float: right; width: 40%; height: 80%; display: flex; align-items: flex-start">
              ...
              <div class="imgArea">
                <el-upload class="uploadImg" ref="upload" :action="BASE_URL + 'swrserveadmin/OssImage/uploadImage'"
                  :data="fileData" name="image" :limit="3" list-type="picture-card" :on-success="uploadSuccess"
                  :on-remove="handleRemove" accept=".jpg,.png,.jpeg">
                  <span>+点击上传</span>
                </el-upload>
              </div>
            </div>
            ...
            <div class="nav">
              ...
              <div>
                <el-date-picker type="date" v-model="repairRegistrationList.start_time" format="YYYY/MM/DD"
            ...
            <div class="nav">
              ...
              <div>
                <el-date-picker type="date" format="YYYY/MM/DD" value-format="YYYY-MM-DD"
                  v-model="repairRegistrationList.plan_end_time" placeholder="选择日期"></el-date-picker>
              </div>
            </div>
            <div class="nav">
            ...
            <div class="nav">
              ...
              <div style="width: 70%; float: right">
                <el-select v-model="scrapRegistrationList.type">
                  <el-option v-for="item in optionType2" :key="item.value" :label="item.label"
                    :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            ...
            <div class="nav">
              ...
              <div style="width: 70%; float: right">
                <el-select v-model="scrapRegistrationList.cause">
                  <el-option v-for="item in optionScope" :key="item.value" :label="item.label"
                    :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            <div class="nav">
              ...
              <div style="width: 70%; float: right">
                <el-select v-model="scrapRegistrationList.process_mode">
                  <el-option v-for="item in optionDisposal" :key="item.value" :label="item.label"
                    :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            <div class="nav" style="height: 35%; align-items: flex-start; display: flex">
              ...
              <div>
                <el-input type="textarea" :autosize="{ minRows: 3, maxRows: 3 }"
                  v-model="scrapRegistrationList.desc"></el-input>
              </div>
            </div>
            <div class="nav">
              <div class="name">关联借单号：</div>
        ...
        <div class="topArea">
          <div class="detailArea" style="height: 350px">
            <div class="nav">
              ...
              <div style="width: 70%; float: right">
                <el-select v-model="damageRegistrationList.damage_man">
                  <el-option v-for="item in optionUser" :key="item.value" :label="item.label"
                    :value="item.value"></el-option>
                </el-select>
              </div>
            </div>
            ...
            <div class="nav" style="height: 20%; align-items: flex-start; display: flex">
              ...
              <div>
                <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 2 }"
                  v-model="damageRegistrationList.desc"></el-input>
              </div>
            </div>
            <div class="nav">
            ...
            <div class="nav">
              ...
              <div>
                <el-date-picker type="date" v-model="damageRegistrationList.repay_time" format="YYYY/MM/DD"
                  value-format="YYYY-MM-DD" placeholder="选择日期"></el-date-picker>
              </div>
            </div>
            <div class="nav" style="height: 20%; align-items: flex-start; display: flex">
              ...
              <div>
                <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 2 }"
                  v-model="damageRegistrationList.repay_desc"></el-input>
              </div>
            </div>
