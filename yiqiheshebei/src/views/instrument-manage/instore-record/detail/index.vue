...
import { instrumentRecordDetail } from '@service/instrument-manage/batch-instrument-warehouse'
...
const getTableData = () => {
  instrumentRecordDetail({ wholesale_purchase: props.wholesale_purchase }).then((res: any) => {
