  ...
  <main v-show="reportShow">
    ...
    <div class="infoArea">
      ...
      <div class="row">
        ...
        <span style="color: #05c65d">
          {{ infoData.new_summary.total_origin_money ? infoData.new_summary.total_origin_money.toFixed(2) : '' }}
        </span>
        <span>元</span>
        <span>，折旧金额为</span>
        <span style="color: #05c65d">
          {{ infoData.new_summary.total_new_money ? infoData.new_summary.total_new_money.toFixed(2) : '' }}
        </span>
        <span>元</span>
        <!--        <span>，实物金额为</span>-->
    ...
    <div class="tableArea">
      <el-table :data="tableData" style="width: 100%" :header-cell-style="{ background: '#EFEFEF' }">
        ...
        <el-table-column align="left" prop="number" label="分类编号"></el-table-column>
        <el-table-column align="left" prop="asset_number" label="学校编号"></el-table-column>
        ...
        <el-table-column align="left" prop="unit" label="厂家"></el-table-column>
        <el-table-column align="left" prop="inventory_num" label="盘点数"></el-table-column>
        <el-table-column align="left" prop="yk_price" label="总金额"></el-table-column>
        <el-table-column align="left" prop="position" label="位置"></el-table-column>
        <!--        <el-table-column align="left" prop="" label="库存数">-->
        <!--          <template #default="scope">-->
        <!--            {{ scope.row.inventory_num - scope.row.num }}-->
        <!--          </template>-->
        <!--        </el-table-column>-->
        <!--        <el-table-column align="left" prop="num" label="盈亏数"></el-table-column>-->
        <!--        <el-table-column align="left" prop="yk_price" label="盈亏金额"></el-table-column>-->
      </el-table>
    </div>
...
const initData = (ID: number) => {
  ...
  getCheckReportList({ inventory_total_id: ID, keyword: '' }).then((res) => {
    ...
    res.data.list.forEach((item) => {
      item.allPrice = (item.inventory_num * item.price).toFixed(2)
