    ...
    >
      <div class="topArea">
        <div class="status-box">
          损耗报废状态:
          <!-- <span style="margin-left: 20%; color: #ee9a59">
        ...
        <div class="base-box-detail">
          <div class="base-box">
            <div class="fl">
              <div class="line">
                ...
                <div class="lineValue">
                  {{ scrapRegistrationList.mode === 1 ? '损耗' : '报废' }}
                </div>
              </div>
              ...
              <div class="line">
                ...
                <div class="lineValue">{{ scrapRegistrationList.desc }}</div>
              </div>
              <div class="line">
                <div class="name">总价值</div>
                <div class="lineValue">{{ scrapRegistrationList.price }}</div>
              </div>
              <div class="line">
            ...
            <div class="name" style="width: 100%; height: 20%">照片说明</div>
            <div v-for="item in scrapRegistrationList.pic" :key="item.id">
              <img :src="item.url_path" class="imgArea" />
            </div>
          </div> -->
          ...
          <div class="line" style="float: right; margin-bottom: 20px">
...
import { postInstrumentExamineInfo, getScrapDetailInfo } from '@/service/instrument-manage/scrapRegistration/index'
import { scrapDetailData, instrumentExamineData } from '@/service/instrument-manage/scrapRegistration/types'
