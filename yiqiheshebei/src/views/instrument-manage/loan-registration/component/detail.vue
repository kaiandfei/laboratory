    ...
    >
          ...
          <div class="base-box">
            <div class="fl">
              ...
              <div class="line">
                ...
                <div v-show="lendRegistrationList.list.length === 0">无</div>
              </div>
            </div>
            <div class="fr">
              <div class="line">
              ...
              <div class="line">
                ...
                <div>
                  <span v-show="lendRegistrationList.status === 1">{{ '未归还' }}</span>
                  <span v-show="lendRegistrationList.status === 2">{{ '部分归还' }}</span>
              ...
              <div class="line">
                ...
                <div v-for="item in lendRegistrationList.nuReturn" :key="item.id">
                  ...
                  {{ item.residue + '个' }}
                  <div>
                    {{ '[ 维修：' + item.maintain_total }}
                    {{ '损耗：' + item.scrap_total }}
                    {{ '损坏：' + item.damage_total + ' ]' }}
                  </div>
                </div>
                <div v-show="lendRegistrationList.nuReturn.length === 0">无</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="middleArea">
        <div class="left">
          ...
          <div class="nav" style="min-height: 40px; display: block">
            <div class="name" style="width: 50%">归还仪器位置及数量清单</div>
            ...
            <span v-show="lendRegistrationList.returnList.length === 0" class="value" style="margin-left: 20px">
              无
            </span>
          </div>
        </div>
