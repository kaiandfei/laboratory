...
import Detail from '@views/equipment-manegement/instore-record/detail/index.vue'
...
import { equipmentRecord } from '@service/instrument-manage/batch-instrument-warehouse'
...
const getTableData = () => {
  equipmentRecord(baseObj.value).then((res: any) => {
