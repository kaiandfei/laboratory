  ...
  <div>
    <header>
      ...
      <div class="searchArea">
        <!-- <input v-model="compensateValue" placeholder="请输入关键字" style="float: left; width: 60%; height: 30px" />
    ...
    <div class="buttonArea">
      <div class="title">设备损耗、报废审核列表</div>
    </div>
    <div class="tableArea">
      <el-table
      ...
      >
        ...
        <el-table-column label="损耗报废单号" width="160" prop="record_number" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="处理方式" prop="process_mode" show-overflow-tooltip width="130">
          <template #default="scope">
        ...
        <el-table-column
          ...
          width="130"
        ></el-table-column>
        <el-table-column label="提交人" prop="user_name" show-overflow-tooltip width="100"></el-table-column>
        <el-table-column label="状态" prop="status" sortable="custom" show-overflow-tooltip width="80">
          <template #default="scope">
        ...
        <el-table-column label="操作" prop="">
          <template #default="scope">
            <div v-show="scope.row.list">
              ...
              <div style="color: #05c65d; float: left; cursor: pointer" @click="operate(scope.row.id, 3)">详情</div>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
import { getScrapRegistrationlist } from '../../../service/equ-manage/scrapRegistration/index'
...
const initData = () => {
  getScrapRegistrationlist({ keyword: '', page: currentPage.value, ...sortData }).then((res) => {
...
const search = () => {
  getScrapRegistrationlist({ keyword: compensateValue.value, page: currentPage.value, ...sortData }).then((res) => {
    instrumentList.value = res.data
    total.value = res.data.total
  })
}
