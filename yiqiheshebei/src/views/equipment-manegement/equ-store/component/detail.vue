  ...
  <div>
    ...
    >
      <div class="top">
        ...
        <div class="nav">{{ '使用年限：' + detailList.number_year + detailList.number_year_unit }}</div>
        <div class="nav">{{ '总库存：' + detailList.total }}</div>
      </div>
      <div class="middle">
        <el-table
        ...
        >
          ...
          <el-table-column label="采购批次" prop="bacth"></el-table-column>
          ...
          <el-table-column label="二维码" prop="qr_code">
            <template #default="scope">
              <div :id="'qrCode' + scope.$index" style="float: left">
                <qrcode-vue class="qr-img" :value="scope.row.qr_code" :size="50" level="H" />
              </div>
...
// import { getDetailList } from '@/service/equ-manage/equ-manage/index'
import { detailData } from '@/service/equ-manage/equ-manage/types'
...
const downLoad = (index: number) => {
  ...
  console.log(' ~ file: index.vue ~ line 295 ~ downLoad ~ url', url)
