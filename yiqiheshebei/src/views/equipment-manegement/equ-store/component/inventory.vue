    ...
    >
      <el-form :rules="rules" :model="inventoryForm" label-width="150px" class="rule-form">
        ...
        <el-form-item label="位置" prop="outPosition">
          <el-select
            v-model="inventoryForm.school_laboratory_id"
            :change="getData(inventoryForm.school_laboratory_id)"
            style="width: 30%"
          >
          ...
          <el-select v-model="inventoryForm.number_plies" style="width: 30%">
            <el-option
              v-for="n in optionPlies(storeList, inventoryForm.store_id || 1)"
              :key="n.value"
              :label="n.name"
              :value="n.value"
            ></el-option>
...
import { getLaboratoryList, storeByLaboratory, postCheckList } from '@/service/equ-manage/equ-manage/index'
import { checkList } from '@/service/equ-manage/equ-manage/types'
