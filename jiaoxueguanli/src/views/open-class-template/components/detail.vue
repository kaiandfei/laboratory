  ...
  <div>
    <div class="header">
      ...
      <div class="my-btn-box">
        <button v-if="forms.type === 2" class="my-btn" @click="back(forms)">编辑</button>
        <button class="my-btn" @click="exportItem()">导出</button>
        <button class="my-btn cancel" @click="back()">返回</button>
      </div>
    </div>
    <div class="box">
      <div class="line-box">
        ...
        <div
          class="line border-b"
          v-for="(item, index) in forms.evaluation_project"
          :key="index"
        >
...
<script>
import { findEvaluationProjectTemplate } from '@/network/open-class'
      ...
      axios
        .post(
          process.env.VUE_APP_APP_BASEURL +
            '/teach/EvaluationProjectTemplate/downloadEvaluationProject',
