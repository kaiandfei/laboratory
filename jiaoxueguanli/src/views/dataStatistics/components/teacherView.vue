  ...
  <div>
    <div class="content-box">
      <div class="content">
        ...
        <div class="chart-box">
          <p>今日需开课详情</p>
          <chart-bar :seriesData="seriesData11" :xAxisData="xAxisData11" :type="1" />
        </div>
      </div>
      <div class="content">
        <div class="title-box">
    ...
    <div class="content-box">
      <div class="content class-num">
        ...
        <div class="text-box">
          <p>实验开课数量</p>
          <p>第{{ weeknow }}周累计/本学期累计/本学期应开课</p>
    ...
    <div class="content-box">
      ...
      <div class="content">
        <div class="title-box">
          <div>
            <p>学生课中实验操作步骤图评价情况</p>
            <!--            <p><span>五星/800</span><span>四星/200</span><span>三星/100</span><span>二星/100</span><span>一星/100</span></p>-->
          </div>
        </div>
        <div class="chart-box">
          <div class="top-text">
      ...
      <div class="content">
        ...
        <div class="chart-box">
          <div class="top-text">
            <!--            <div>-->
            <!--              <p>本学期累计（实际/理论&nbsp;）</p>-->
            <!--              <span>600/700≈86%</span>-->
            <!--            </div>-->
            <!--            <div>-->
            <!--              <p>第{{weeknow}}周累计（实际/理论&nbsp;）</p>-->
            <!--              <span>100/120≈83%</span>-->
            <!--            </div>-->
            <div>
              <p>本学期累计（实际/理论&nbsp;）</p>
    ...
    <div class="content-box">
      <div class="content content-l-b">
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(item, index) in myClassList" :key="index">
              <td>{{ index + 1 }}</td>
...
export default {
  ...
  data() {
    return {
      ...
      xAxisData21: [],
      seriesData31: [],
      xAxisData31: ['本学期应开课', '本学期累计', '第二周累计'],
      seriesData32: [],
      xAxisData32: ['本学期分组累计', '本学期演示累计', '本周分组累计', '本周演示累计'],
      seriesData33: [
        {
          name: '第一个',
          type: 'line',
  ...
  methods: {
    ...
    classToday() {
      ...
      expType(this.screenMessage).then((res) => {
        this.seriesData32 = [
          {
            name: '老师',
            type: 'bar',
      ...
      myStatus(this.screenMessage).then((res) => {
        this.go_class_lv = res.data.go_class_lv
        this.beforc_lv = res.data.befor_lv
        this.report_lv = res.data.report_lv
        this.after_lv = res.data.after_lv
        this.report_pic = res.data.report_pic
        this.teachername = res.data.name
        this.teachergrade = res.data.grade
      })
      myClassList(this.screenMessage).then((res) => {
