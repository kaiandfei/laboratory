    ...
    <div class="line" v-for="(item, index) in forms.reportTempletData" :key="index">
      ...
      <div class="details" v-if="item.type === 2">
        ...
        <el-input
          ...
          :rows="2"
          placeholder="请输入内容"
          v-model="item.teachercontent.input"
          :disabled="disabled"
        >
        </el-input>
      </div>
      ...
      <div class="details" v-if="item.type === 5">
        ...
        <el-input
          class="border-b"
          v-model="item.teachercontent.input2"
          placeholder="填空题"
          :disabled="disabled"
        ></el-input>
      ...
      <div class="details" v-if="item.type === 6">
        ...
        <el-input
          class="border-b"
          v-model="item.teachercontent.input3"
          placeholder="填空题"
          :disabled="disabled"
        ></el-input>
        <el-input
          class="border-b"
          v-model="item.teachercontent.input4"
          placeholder="填空题"
          :disabled="disabled"
        ></el-input>
      </div>
      <div class="details" v-if="item.type === 7">
        ...
        <el-radio-group v-model="item.teachercontent.value" :disabled="disabled">
