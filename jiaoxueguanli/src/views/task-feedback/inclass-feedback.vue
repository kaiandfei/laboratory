<template>
  <div class="content">
    <p class="title">学生任务反馈<i class="el-icon-arrow-right" />学生课中</p>
    <top-filter
      ref="filterRef"
      :options="[
        'semester',
    ...
    <div class="body_item">
      <div v-show="uploadFlag2" class="inputName">
        <img @click="closeUpload(2)" src="@images/experimentalRecord/close.png" alt="" />
        ...
        <div class="upload_box">
          <el-upload
            ...
            name="image"
            :on-success="
              (response, file, fileList) => onsuccess(response, file, fileList, 2)
            "
      ...
      <div class="item-box" v-for="(item, index) in reportData" :key="index">
        <div class="base_msg">
        ...
        <div v-for="(expItem, expIndex) in item.exp" :key="expIndex">
          ...
          >
            ...
            <div class="grade_box">
              <div
                class="grade-item"
                v-for="(item2, index2) in rankListReport[index][expIndex]"
                :key="index2"
              >
                <p>
                  等级{{ item2.level }}
                  <img
                    @click="changeRankShow2(item2)"
                    v-show="item2.show"
                ...
                <p
                  @click="
                    uploadImg2(index2, item.go_class_id, classItem.class_id, expItem)
                  "
                >
              ...
              <div class="echartBox">
                <div class="echartDiv">
                  <chart-bar
                    v-if="seriesData2[index]"
                    :seriesData="seriesData2[index][expIndex]"
                    :xAxisData="seriesData2[index][expIndex]"
                    :type="5"
                    :width="154"
                    :height="154"
                  />
            ...
            <div class="student_list">
              <div
                v-show="showDetail(rankListReport[index][expIndex], item)"
                class="student_score"
      ...
      <div v-show="showChildFlag2 !== -1" class="child_img_list">
        <img
          class="close_icon"
          src="@images/taskFeedback/close-white.png"
          alt=""
          @click="showChildFlag2 = -1"
        />
...
export default {
  ...
  methods: {
    ...
    getData(obj, page) {
      ...
      getReportData(message)
        .then((res) => {
          ...
          this.reportData.forEach((course) => {
            const expArr = []
            ...
            this.rankListReport.push(expArr)
          })
        })
        .then(() => {
          this.drawPie(2)
    ...
    uploadImg2(index, goClassId, classId, item) {
