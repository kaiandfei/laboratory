      ...
      <div class="content">
        <div class="title">
          ...
          <div class="message-box">
            <div class="text-box">
              <p>
                <span class="has-bg yellow"> 学生课中报告 </span>
                <span class="big-size yellow">
                  {{ reportClassData.total1 }}
                </span>
              </p>
            </div>
            <div class="text-box">
        ...
        <div class="chart-box">
          ...
          <div class="chart">
            <chart-bar
              ...
              :xAxisData="reportClassData.list || []"
            />
          </div>
        </div>
      </div>
      <div class="content">
        <div class="title">
          ...
          <div class="message-box">
            <div class="text-box">
              <p>
                <span class="has-bg green"> 学生课中报告次数完成率 </span>
              </p>
              <p>
                <span> 实际/理论&nbsp; </span>
                <span class="big-size green">
                  {{ reportClassCompletionData.practical }}/{{
                    reportClassCompletionData.expect
                  }}≈{{ reportClassCompletionData.semesterlv }}%
                </span>
              </p>
            </div>
            <div class="text-box">
            ...
            <div class="text-box">
              ...
              <p>
                <span> 实际/理论&nbsp; </span>
                <span class="big-size green">
                  {{ reportClassCompletionData.weekpractical }}/{{
                    reportClassCompletionData.weekexpect
                  }}≈{{ reportClassCompletionData.weeklv }}%
                </span>
              </p>
            </div>
          </div>
        ...
        <div class="chart-box">
          ...
          <div class="chart">
            <chart-bar
              ...
              :xAxisData="reportClassCompletionData.listClass || []"
            />
          </div>
        </div>
      </div>
      <div class="content">
        <div class="title">
          ...
          <div class="message-box">
            <div class="text-box">
              <p>
                <span class="has-bg blue"> 学生课中报告反馈 </span>
              </p>
              <p>
              ...
              <p>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.semesterA }}
                </span>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.semesterB }}
                </span>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.semesterC }}
                </span>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.semesterD }}
                </span>
              </p>
            </div>
            <div class="text-box">
            ...
            <div class="text-box">
              ...
              <p>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.weekA }}
                </span>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.weekB }}
                </span>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.weekC }}
                </span>
                <span class="flex1 big-size blue">
                  {{ reportClassBackData.weekD }}
                </span>
              </p>
            </div>
          </div>
        ...
        <div class="chart-box">
          ...
          <div class="chart">
            <chart-bar
              ...
              :xAxisData="reportClassBackData.classList || []"
            />
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getData(obj) {
      reportClass(obj).then((result) => {
        this.reportClassData = result.data
        this.seriesData1 = [
          {
            name: '本学期',
            type: 'bar',
      ...
      reportClassCompletion(obj).then((result) => {
        this.reportClassCompletionData = result.data
        this.seriesData2 = [
          {
            name: '本学期',
            type: 'bar',
      ...
      reportClassBack(obj).then((result) => {
        this.reportClassBackData = result.data
        this.seriesData3 = [
          {
            name: '等级A',
            type: 'bar',
