      ...
      <div class="content">
        <div class="title">
          ...
          <div class="message-box">
            <div class="text-box">
              <p>
                <span class="has-bg yellow"> 学生课后习题 </span>
                <span class="big-size yellow">
                  {{ afterClassData.total1 }}
                </span>
              </p>
            </div>
            <div class="text-box">
        ...
        <div class="chart-box">
          <p>学生课后习题</p>
          <div class="chart">
            <chart-bar :seriesData="seriesData1" :xAxisData="afterClassData.list || []" />
          </div>
        </div>
      </div>
      <div class="content">
        <div class="title">
          ...
          <div class="message-box">
            <div class="text-box">
              <p>
                <span class="has-bg green"> 学生课后习题完成率 </span>
              </p>
              <p>
                <span> 实际/理论&nbsp; </span>
                <span class="big-size green">
                  {{ afterClassCompletionData.practical }}/{{
                    afterClassCompletionData.expect
                  }}≈{{ afterClassCompletionData.semesterlv }}%
                </span>
              </p>
            </div>
            <div class="text-box">
            ...
            <div class="text-box">
              ...
              <p>
                <span> 实际/理论&nbsp; </span>
                <span class="big-size green">
                  {{ afterClassCompletionData.weekpractical }}/{{
                    afterClassCompletionData.weekexpect
                  }}≈{{ afterClassCompletionData.weeklv }}%
                </span>
              </p>
            </div>
          </div>
        ...
        <div class="chart-box">
          ...
          <div class="chart">
            <chart-bar
              ...
              :xAxisData="afterClassCompletionData.listClass || []"
            />
          </div>
        </div>
      </div>
      <div class="content">
        <div class="title">
          ...
          <div class="message-box">
            <div class="text-box">
              <p>
                <span class="has-bg blue"> 学生课后习题反馈 </span>
              </p>
              <p>
              ...
              <p>
                <span class="flex1 big-size blue">
                  {{ afterClassBackData.semesterA }}
                </span>
                <span class="flex1 big-size blue">
                  {{ afterClassBackData.semesterB }}
                </span>
                <span class="flex1 big-size blue">
                  {{ afterClassBackData.semesterC }}
                </span>
                <span class="flex1 big-size blue">
                  {{ afterClassBackData.semesterD }}
                </span>
              </p>
            </div>
            <div class="text-box">
        ...
        <div class="chart-box">
          ...
          <div class="chart">
            <chart-bar
              ...
              :xAxisData="afterClassBackData.classList || []"
            />
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getData(obj) {
      afterClass(obj).then((result) => {
        this.afterClassData = result.data
        this.seriesData1 = [
          {
            name: '本学期',
            type: 'bar',
      ...
      afterClassCompletion(obj).then((result) => {
        this.afterClassCompletionData = result.data
        this.seriesData2 = [
          {
            name: '本学期',
            type: 'bar',
      ...
      afterClassBack(obj).then((result) => {
        this.afterClassBackData = result.data
        this.seriesData3 = [
          {
            name: '等级A',
            type: 'bar',
