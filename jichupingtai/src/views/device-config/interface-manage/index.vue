  ...
  <main>
    ...
    <div class="table-box">
      ...
      >
        ...
        <el-table-column property="" label="接口" align="left">
        ...
        <el-table-column property="" label="所属公司" align="left">
          <template #default="scope">
            <div>
              <span v-if="!scope.row.edit">{{ scope.row.gs }}</span>
              <el-input v-else type="text" v-model="scope.row.gs" />
            </div>
          </template>
        </el-table-column>

        <!-- <el-table-column property="type" label="接口/菜单/按钮"></el-table-column> -->
...
const add = () => {
  tableData.value.push({ title: '', gs: '', edit: true })
}
...
const delItem = (id: number, index: number) => {
  ...
  ElMessageBox.confirm('提示:删除接口会删除所有的对应接口的信息，确认需要删除?', '删除接口', {
