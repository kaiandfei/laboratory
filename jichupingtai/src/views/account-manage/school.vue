<template>
  ...
  <main>
    ...
    >
      ...
      <el-table-column align="left" property="gradename" label="执教年级" min-width="15" />
    ...
    <template v-slot:main>
      <div class="form-box">
        ...
        <div class="mb-20">
          ...
          <div
            v-if="editFrom.school_type_id == 1 || editFrom.school_type_id == 6 || editFrom.school_type_id == 7"
            @click="checkeditPhaseStudyId('1')"
            class="fl f-align-c mr-20"
          >
            <img :src="editFrom.phase_study_id.indexOf('1') !== -1 ? selOnG : selOffG" alt="" class="mr-18" />
            <!-- <img :src="teacherRole === 1 ? selOn : selOff" alt="" /> -->
            <span>小学</span>
          </div>
          <div
            v-if="
              editFrom.school_type_id == 2 ||
              editFrom.school_type_id == 4 ||
              editFrom.school_type_id == 6 ||
              editFrom.school_type_id == 7
            "
            @click="checkeditPhaseStudyId('2')"
            class="fl f-align-c mr-20"
          >
            <img :src="editFrom.phase_study_id.indexOf('2') !== -1 ? selOnG : selOffG" alt="" class="mr-18" />
            <!-- <img :src="teacherRole === 1 ? selOn : selOff" alt="" /> -->
            <span>初中</span>
          </div>
          <div
            v-if="
              editFrom.school_type_id == 3 ||
              editFrom.school_type_id == 4 ||
              editFrom.school_type_id == 5 ||
              editFrom.school_type_id == 7
            "
            @click="checkeditPhaseStudyId('3')"
            class="fl f-align-c mr-20"
          >
            <img :src="editFrom.phase_study_id.indexOf('3') !== -1 ? selOnG : selOffG" alt="" class="mr-18" />
            <!-- <img :src="teacherRole === 1 ? selOn : selOff" alt="" /> -->
            <span>高中</span>
          </div>
        </div>
        ...
        <div class="mb-20" v-show="editFrom.role_ids.indexOf(2) !== -1">
          <span class="w-108 fl">管理实验室:</span>
          <div class="fr school-class" v-if="editFrom.subject_laborator !== []">
            <el-tabs>
...
getFindArea(1, 0, 1)
let route = useRoute()
console.log('luyou', route.params.school_id)
...
const sChange = (item: any) => {
  ...
  getSchoolClass({ id: item.id }).then((res) => {
    ...
    console.log(fromData.subject_laborator)
  })
}
