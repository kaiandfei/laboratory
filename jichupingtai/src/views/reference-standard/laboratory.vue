<template>
  ...
  <main>
    ...
    >
      ...
      <el-table-column align="center" label="实验室参考标准">
        <el-table-column align="left" property="address" label="省级标准" min-width="20">
          <template #default="props">
            <div class="point" style="height: 20px; width: 100%" @click="change(props.row.id, 1)">
              <img v-show="props.row.lab_standard === 1" src="@assets/images/common/right-green.png" alt="" />
            </div>
          </template>
        </el-table-column>
        <el-table-column align="left" property="address" label="市级标准" min-width="20">
          <template #default="props">
            <div class="point" style="height: 20px; width: 100%" @click="change(props.row.id, 2)">
              <img v-show="props.row.lab_standard === 2" src="@assets/images/common/right-green.png" alt="" />
            </div>
          </template>
        </el-table-column>
        <el-table-column align="left" property="address" label="区县级标准" min-width="20">
          <template #default="props">
            <div class="point" style="height: 20px; width: 100%" @click="change(props.row.id, 3)">
              <img v-show="props.row.lab_standard === 3" src="@assets/images/common/right-green.png" alt="" />
            </div>
          </template>
        </el-table-column>
      </el-table-column>
...
getArea()
const change = (id: any, lab_standard: any) => {
  changeStandard({ id, lab_standard }).then((res) => {
    if (res.code === 10) {
      ElMessage({
        type: 'success',
        message: '修改成功!'
